...
public void MultiMod_OnLoaded(bool bReload)
{
	...
	{
		MultiMod_GetModProp(i, MultiModProp_InfoKey, szKey, sizeof szKey);
		MultiMod_BuildPath(MultiModPath_ModFolder, i, szPath, sizeof szPath, "/%s-downloads.ini", szKey);
...
public void OnMapStart()
{
	...
	char szKey[MM_MAX_MOD_PROP_LENGTH];
	MultiMod_GetModProp(iModIndex, MultiModProp_InfoKey, szKey, sizeof szKey);
	
	char szPath[PLATFORM_MAX_PATH];
	MultiMod_BuildPath(MultiModPath_ModFolder, iModIndex, szPath, sizeof szPath, "/%s-downloads.ini", szKey);
