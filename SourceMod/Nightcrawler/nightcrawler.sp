...
#define PLUGIN_AUTHOR "steamcommunity.com/id/Khalid123"
...
char g_szMinePlacementSound[] = "nightcrawler/mine_deploy.mp3";
char g_szMineArmedSound[] = "nightcrawler/mine_activate.mp3";
char g_szMineArmingSound[] = "nightcrawler/mine_charge.mp3";
char g_szMineLaserTouchSound[] = "nightcrawler/sonic_sound.mp3";

char g_szTeleportSound[] = "nightcrawler/teleport.mp3";
char g_szAdrenalineInjectionSound[] = "nightcrawler/adrenaline_shot.mp3";
char g_szNightcrawlerDeathSound[][] =  {
	"nightcrawler/nc_death1.mp3", 
	"nightcrawler/nc_death2.mp3", 
	"nightcrawler/nc_death3.mp3"
};

char g_szNightcrawlerKnifeHitSound[][] = {
	"nightcrawler/sword_strike1.mp3",
	"nightcrawler/sword_strike2.mp3",
	"nightcrawler/sword_strike4.mp3"
};

#define DEFAULT_MUSIC_VOLUME 		7

#define SNDCHAN_AMBIENT_SOUNDS 		250
#define SNDCHAN_SURITEMS			SNDCHAN_STATIC
#define SNDCHAN_MINE_SETUP			150
#define SNDCHAN_MINE_SETUP2			160
#define SNDCHAN_MINE_DETECTION		170
#define SNDCHAN_MINE_ACTIVE			180
#define SNDCHAN_ROUND_WIN			190
#define SNDCHAN_FREEZE_LIGHT		200
#define SNDCHAN_KNIFE_NC_HIT		SNDCHAN_STATIC
#define SNDCHAN_PLAYER_DEATH		220
#define SNDCHAN_TELEPORT			SNDCHAN_STATIC
...
int g_iItemsData[MAX_PLAYER_ITEMS][PlayerItems] =  {
	{ 1, "Laser Detector" }, 
	{ 1, "Laser Mines [2]" }, 
	{ 1, "Adrenaline" }, 
	{ 1, "Suicide Bomb" }, 
...
// Maybe change everything into a charge basis (2 charge == 2 time use and so on)?
//int g_iPlayerItemCharges[MAXPLAYERS + 1][MAX_PLAYER_ITEMS];
//bool g_bPlayerHasItem[MAXPLAYERS + 1][MAX_PLAYER_ITEMS];

// -- Settings #1: Default --
#define g_iDefault_MinPlayers							2
#define g_iDefault_ChooseNCPlayersMode  				MODE_QUEUE

#define g_szDefault_ChatPrefix 							"\x04[NightCrawlers-Beta] "

#define g_szDefault_SurvivorName 						"Survivor"
#define g_szDefault_SurvivorTeamName  					"Survivors"
#define g_szDefault_NCName 								"Nightcrawler"
#define g_szDefault_NCTeamName  						"NightCrawlers"

#define g_bDefault_KeepSurvivingNC						true
#define g_flDefault_NCSpeedMultiplier  					1.1
#define g_flDefault_NCGravityMultiplier 	 			0.7
#define g_flDefault_NCStartingHealth  					160.0

#define g_flDefault_NCRatio  							3.0
#define g_iDefault_LaserMode  							LMODE_KILL
#define g_iDefault_MaxGivenLaserCount  					-1
#define g_flDefault_LaserRatio  						3.0
int g_iDefault_SurvivorLaserColor_Normal[4] = 			{ 0, 0, 255, 180 };
int g_iDefault_SurvivorLaserColor_Aim[4] = 				{ 255, 0, 0, 255 };
#define g_iDefault_PointsPerKill_NC  					3
#define g_iDefault_PointsHSBonus  						1
#define g_iDefault_PointsPerKill_Survivor  				1

#define g_szDefault_ManaName  							"Mana"
#define g_flDefault_MaxMana  							200.0
#define g_flDefault_ManaRegenTime  						1.5
#define g_flDefault_ManaRegenAmount  					5.0
#define g_flDefault_ManaTeleportCost  					75.0

#define g_flDefault_ChooseWeaponTime  					25.0

#define g_szDefault_LightStyle  						"b"

#define g_flDefault_NCVisibleTime  						2.3
#define g_bDefault_BlockFallDamage_NC  					true

#define g_bDefault_RemoveShadows  						true
#define g_bDefault_MakeFog  							true

#define g_flDefault_MinePlacement_MaxDistanceFromWall	32.0
#define g_iDefault_MineMaxPlayers  						3
#define g_iDefault_MineGiveCount  						2
#define g_flDefault_MinePlacement_PlacementTime  		0.4
int g_iDefault_MineLaserColor_Normal[4] =  				{ 0, 0, 200, 150 };
int g_iDefault_MineLaserColor_Aim[4] =  				{ 200, 0, 0, 150 };
#define g_flDefault_MineActivateTime  					3.0

#define g_flDefault_SuicideBombExplodeTime  			2.5
#define g_flDefault_SuicideBombDamage  					320.0
#define g_flDefault_SuicideBombRadius  					235.0

#define g_flDefault_AdrenalineSpeedMultiplier  			1.31
#define g_flDefault_AdrenalineAttackSpeedMultiplier 	0.8
#define g_iDefault_AdrenalineExtraHealth  				70
#define g_flDefault_AdrenalineTime  					8.7

#define g_flDefault_DetectorUpdateTime  				0.5
#define g_iDefault_DetectorMaxPlayers  					2
#define g_flDefault_Detector_UnitsPerChar  				35.0
#define g_flDefault_Detector_Radius  					700.0
#define g_szDefault_DetectorNormalColor  				"#FFFFFF"
#define g_szDefault_DetectorCloseColor  				"#FF0000"
#define g_szDefault_DetectorDefaultMessage  			"NC Detector:"

#define g_iDefault_HegrenadeGiveAmount  				2
#define g_iDefault_HegrenadeRegenAmount  				1
#define g_iDefault_HegrenadeMax  						3
#define g_flDefault_HegrenadeRegenTime  				60.0

#define g_iDefault_FrostGrenadeGiveAmount  				3
#define g_flDefault_FrostGrenadeRadius  				64.0
//#define g_flDefault_FrostGrenadeActivationDelay  		1.3
#define g_flDefault_FrostGrenadeFreezeDuration  		1.2
int g_iDefault_FrostGrenadeBeamFollowColor[4] =			{ 75, 75, 255, 128 };

#define g_bDefault_InfiniteBPAmmo  						true

#define g_flDefault_RoundWinSoundsVolume	 			0.8
...
float g_flRoundWinSoundsVolume;
...
ArrayList g_Array_RoundWinSounds_NC, g_Array_RoundWinSounds_Survivor;
int g_iRoundWinSoundsCount_NC, g_iRoundWinSoundsCount_Survivor;

ArrayList g_Array_AmbientRoundSounds;
int g_iAmbientRoundSoundsCount;

int g_iLastAmbientSoundIndex = -1;
bool g_bClientAmbientMusicDisabled[MAXPLAYERS + 1];
int g_iClientAmbientMusicVolumeIndex[MAXPLAYERS + 1];
float g_flAmbientMusicVolumes[] = {
	1.0,
	0.8,
	0.6,
	0.5,
...
Menu g_hMusicVolumeMenu, g_hMusicSettingsMenu;
...
void ActivateAdrenaline(int client)
{
	...
	EmitSoundToClientAny(client, g_szAdrenalineInjectionSound, SOUND_FROM_PLAYER, SNDCHAN_SURITEMS);
...
bool SetupMine(float position[3], float vnormal[3])
{
	...
	if (ent > -1)
	{
		...
		EmitSoundToAllAny(g_szMinePlacementSound, ent, SNDCHAN_MINE_SETUP);
		EmitSoundToAllAny(g_szMineArmingSound, ent, SNDCHAN_MINE_SETUP2);
...
public void SDKCallback_ThinkPost_LaserBeam(int iLaserEnt)
{
	...
	if (TR_DidHit() && IsValidPlayer((iEnt = TR_GetEntityIndex())))
	{
		...
		if (g_flMineLaser_PlayerTouch_SoundPlayCooldown[iEnt] < (flGameTime = GetGameTime()))
		{
			...
			EmitSoundToAllAny(g_szMineLaserTouchSound, iEnt, SNDCHAN_MINE_DETECTION);
		}
	}
...
public Action ActivateTimer(Handle timer, Handle data)
{
	...
	EmitSoundToAllAny(g_szMineArmedSound, ent, SNDCHAN_MINE_ACTIVE);
...
public Action SoundHook_BlockSounds(int clients[64], int &numClients, char sample[PLATFORM_MAX_PATH], int &entity, int &channel, float &volume, int &level, int &pitch, int &flags)
{
	// Player
	if (IsValidPlayer(entity))
	{
		if (StrContains(sample, "physics") != -1 || StrContains(sample, "footsteps") != -1 || StrContains(sample, "land") != -1 || StrContains(sample, "/damage") != -1)
		{
			// Player not ninja, play footsteps
			if (GetClientTeam(entity) == CS_TEAM_NC)
			{
				return Plugin_Stop;
			}
		}
		...
		// Knife hit wall sounds
	else if(StrContains(sample, "knife_hit_") != -1)
	{
		if(IsValidEdict(entity) && entity > MaxClients)
		{
			int iPlayer = GetEntPropEnt(entity, Prop_Send, "m_hOwner");
			
			if(IsValidPlayer(iPlayer) && GetClientTeam(iPlayer) == CS_TEAM_NC)
			{
				return Plugin_Stop;
			}
		}
	...
	// Knife hit player sounds
	else if(StrContains(sample, "knife_slash", true) != -1 || 
			StrContains(sample, "knife_stab", true) != -1 || 
			StrContains(sample, "knife_hit", true) != -1 )
	{
		//PrintToChatAll("Changed");
		...
		if(IsValidEdict(entity) && entity > MaxClients)
		{
			...
			{
				if(GetClientTeam(iPlayer) == CS_TEAM_NC && GetClientAimTarget(iPlayer, true) != -1)
				{
					// Block sound here and emit sound at OnTakeDamage Hook
					
					//clients[numClients++] = iPlayer;
					//FormatEx(sample, PLATFORM_MAX_PATH, "*%s", g_szNightcrawlerKnifeHitSound[GetRandomInt(0, sizeof(g_szNightcrawlerKnifeHitSound) - 1)]);
					//volume = 1.0;
...
public void OnPluginStart()
{
	...
	AddNormalSoundHook(SoundHook_BlockSounds);
	...
	g_hCookie_Settings = RegClientCookie("nightcrawler_settings", "", CookieAccess_Protected);
}
...
{	
	...
	if(winner == CS_TEAM_NC)
	{
		if(!g_iRoundWinSoundsCount_NC)
		{
			return;
		}
		
		g_Array_RoundWinSounds_NC.GetString(GetRandomInt(0, g_iRoundWinSoundsCount_NC - 1), szSound, sizeof szSound);
	}
	
	else if(winner == CS_TEAM_SURVIVOR)
	{
		if(!g_iRoundWinSoundsCount_Survivor)
		{
			return;
		}
		
		g_Array_RoundWinSounds_Survivor.GetString(GetRandomInt(0, g_iRoundWinSoundsCount_Survivor - 1), szSound, sizeof szSound);
	}
	
	int iPlayers[MAXPLAYERS + 1];
	int iCount = GetPlayers(iPlayers, GP_Flag_NoBots);
	
	for(int i; i < iCount; i++)
	{
		/*if(g_iMusicDisabled[iPlayers[i]])
		{
			
		}
		*/
		PlaySoundClient(iPlayers[i], szSound, g_flRoundWinSoundsVolume);
	}
}
...
void PlaySoundClient(int client, char[] szSound, float selectedVolume)
{
    ...
    EmitSoundToClientAny(client, szSound, SNDCHAN_ROUND_WIN, 0, 0, 0, selectedVolume, 100, -1, NULL_VECTOR, NULL_VECTOR, true, 0.0);
}
...
public void LightCreate(float pos[3])
{
	...
	EmitSoundToAllAny(FROST_FREEZE_SOUND, iEntity, SNDCHAN_FREEZE_LIGHT);
...
void FreezeClient(int client, float time)
{
	...
	vec[2] -= 50.0;
	EmitAmbientSound(FROST_GLASS_IMPACT_SOUND, vec, client, SNDLEVEL_RAIDSIREN);
...
{
	ClientMusicSettings(client, false);
}

void ClientMusicSettings(int client, bool bSave = true)
{
	char szCookies[7];
	
	if(bSave)
	{
		FormatEx(szCookies, sizeof szCookies, "%d:%d", g_bClientAmbientMusicDisabled[client], g_iClientAmbientMusicVolumeIndex[client]);
		SetClientCookie(client, g_hCookie_Settings, szCookies);
	}
	
	// Read Cookies
	else
	{
		GetClientCookie(client, g_hCookie_Settings, szCookies, sizeof szCookies);
		
		char szParts[2][3];
		ExplodeString(szCookies, ":", szParts, sizeof(szParts), sizeof(szParts[]), true);
		
		g_bClientAmbientMusicDisabled[client] = false;
		g_iClientAmbientMusicVolumeIndex[client] = DEFAULT_MUSIC_VOLUME;
		
		if(szParts[0][0])
		{
			g_bClientAmbientMusicDisabled[client] = view_as<bool>(StringToInt(szParts[0]));
		}
		
		if(szParts[1][0])
		{
			g_iClientAmbientMusicVolumeIndex[client] = StringToInt(szParts[1]);
		}
	}
}
...
public Action Command_Teleport(int client, int args)
{
	...
	{
		if (g_flPlayerMana[client] >= g_flManaTeleportCost)
		{
...
public void Frame_DoSpawnStuff(int iUserId)
{
	...
	if (GetClientTeam(client) == CS_TEAM_NC)
	{
		...
		//g_hAbilitiesMenu.Display(client, MENU_TIME_FOREVER);
	}
...
public void Event_RoundStart(Event event, char[] szEventName, bool bDontBroadcast)
{
	...
	if(g_iAmbientRoundSoundsCount)
	{
		CreateTimer(1.0, Timer_RoundStart_StartAmbientSounds, _, TIMER_FLAG_NO_MAPCHANGE);
	}
	
	PluginLog("RoundStart #4");
}

public Action Timer_RoundStart_StartAmbientSounds(Handle hTimer)
{
	char szSound[PLATFORM_MAX_PATH];
	g_iLastAmbientSoundIndex = GetRandomInt(0, g_iAmbientRoundSoundsCount - 1);
	g_Array_AmbientRoundSounds.GetString(g_iLastAmbientSoundIndex, szSound, sizeof szSound);

	int iPlayers[MAXPLAYERS + 1], iCount;
	iCount = GetPlayers(iPlayers, GP_Flag_NoBots);
	
	for(int i, client; i < iCount; i++)
	{
		client = iPlayers[i];
		if(!g_bClientAmbientMusicDisabled[client])
		{
			EmitSoundToClientAny(client, szSound, SOUND_FROM_PLAYER, SNDCHAN_AMBIENT_SOUNDS, _, _, g_flAmbientMusicVolumes[g_iClientAmbientMusicVolumeIndex[client]]);
		}
	}
}
...
public void Event_PlayerDeath(Event event, char[] szEventName, bool bDontBroadcast)
{
	...
	{
		EmitSoundToAllAny(g_szNightcrawlerDeathSound[GetRandomInt(0, sizeof(g_szNightcrawlerDeathSound) - 1)], iVictim, SNDCHAN_PLAYER_DEATH);
	}
...
void MakeHooks(int client, bool bStatus)
{
	if (bStatus)
	{
		...
		SDKHook(client, SDKHook_GroundEntChangedPost, SDKHookCallback_GroundEntChanged);
	}
	...
	else
	{
		...
		SDKUnhook(client, SDKHook_GroundEntChangedPost, SDKHookCallback_GroundEntChanged);
	}
}


public void SDKHookCallback_GroundEntChanged(int client)
{
...
public Action SDKHookCallback_OnTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype)
{
	...
	else if(IsValidPlayer(attacker) && GetClientTeam(attacker) == CS_TEAM_NC)
	{
		EmitSoundToAllAny(g_szNightcrawlerKnifeHitSound[GetRandomInt(0, sizeof(g_szNightcrawlerKnifeHitSound) - 1)], attacker, SNDCHAN_KNIFE_NC_HIT);
...
void BuildItemMenu()
{
	...
	SetMenuTitle(g_hItemMenu, "[NC] Choose Surivor Item Menu:");
...
{
	ITEM_NONE = 0,
	ITEM_FROSTNADE_IMUNITY,
	ITEM_FLARENADE_IMUNITY,
	//ITEM_POISON_IMUNITY,
	ITEM_SHARPSWORD,
	//ITEM_POISONSWORD,
	ITEM_CURSE,
...
enum Abilities
{
	Ability_Name[MAX_ABILITY_NAME_LENGTH]
}

int g_iClientAbility[MAXPLAYERS + 1];
void BuildAbilitiesMenu()
{
	g_hAbilityMenu = new Menu(MenuHandler_AbilitiesMenu, MENU_ACTIONS_ALL);
	g_hAbilityMenu.SetTitle("[NC] Abilities Menu");
	
	char szInfo[3];
	for (int i; i < MAX_NC_ABILITIES; i++)
	{
		IntToString(i, szInfo, sizeof szInfo);
		AddMenuItem(g_hAbilityMenu, szInfo, g_iAbilityData[i][Ability_Name]);
	}
}*/
...
void BuildMainMenu()
{
	...
	SetMenuTitle(g_hMainMenu, "[NC] Main Menu [By: Khalid - v%s]", PLUGIN_VERSION);
	...
	AddMenuItem(g_hMainMenu, "4", "Edit Sound Settings");
	
	AddMenuItem(g_hMainMenu, "998", "Help");
	AddMenuItem(g_hMainMenu, "999", "Admin Menu");
}

void BuildMusicSettingsMenu()
{
	g_hMusicSettingsMenu = new Menu(MenuHandler_MusicSettingsMenu, MENU_ACTIONS_DEFAULT | MenuAction_DisplayItem);
	
	SetMenuTitle(g_hMusicSettingsMenu, "[NC] Ambient Music Menu:");
						
	AddMenuItem(g_hMusicSettingsMenu, "1", "Toggle Ambient Music");
	AddMenuItem(g_hMusicSettingsMenu, "2", "Ambient Music Volume");
	
	g_hMusicVolumeMenu = new Menu(MenuHandler_MusicVolumeMenu);
	SetMenuTitle(g_hMusicVolumeMenu, "[NC] Ambient Music Volume Menu:");
	
	char szDispName[25], szInfo[5];
	for(int i; i < sizeof(g_flAmbientMusicVolumes); i++)
	{
		FormatEx(szInfo, sizeof szInfo, "%d", i);
		FormatEx(szDispName, sizeof szDispName, "%0.2f", g_flAmbientMusicVolumes[i]);
		
		g_hMusicVolumeMenu.AddItem(szInfo, szDispName);
	}
}
...
void BuildWeaponsMenu()
{
	...
	SetMenuTitle(g_hWeaponMenu_Main, "[NC] Select Weapons Menu:");
...
public int MenuHandler_MainMenu(Menu menu, MenuAction action, int param1, int param2)
{
	if (action == MenuAction_Select)
	{
		...
		switch (StringToInt(szInfo))
		{
			...
			case 4:
			{	
				g_hMusicSettingsMenu.Display(param1, MENU_TIME_FOREVER);
			}
...
public int MenuHandler_MusicSettingsMenu(Menu menu, MenuAction action, int param1, int param2)
{
	switch(action)
	{
		case MenuAction_End:
		...
		case MenuAction_DisplayItem:
		{
			char szItemDispName[50];
			if(param2 == 0)			
			{
				FormatEx(szItemDispName, sizeof szItemDispName, "Toggle Ambient Music [%s]", g_bClientAmbientMusicDisabled[param1] ? "Disabled" : "Enabled");
				return RedrawMenuItem(szItemDispName);
			}
			
			if(param2 == 1)
			{
				FormatEx(szItemDispName, sizeof szItemDispName, "Ambient Music Volume [%0.2f]", g_flAmbientMusicVolumes[g_iClientAmbientMusicVolumeIndex[param1]]);
				return RedrawMenuItem(szItemDispName);
			}
		}
		...
		case MenuAction_Select:
		{
			if(param2 == 0)
			{
				g_bClientAmbientMusicDisabled[param1] = !g_bClientAmbientMusicDisabled[param1];
				
				if(g_bClientAmbientMusicDisabled[param1])
				{
					if(g_iLastAmbientSoundIndex != -1)
					{
						char szSound[PLATFORM_MAX_PATH];
						g_Array_AmbientRoundSounds.GetString(g_iLastAmbientSoundIndex, szSound, sizeof szSound);
						Format(szSound, sizeof(szSound), "*/%s", szSound);
						Client_StopSound(param1, param1, SNDCHAN_AMBIENT_SOUNDS, szSound);
					}
				}
				
				ClientMusicSettings(param1, true);
			...
			if(param2 == 1)
			{
				g_hMusicVolumeMenu.Display(param1, MENU_TIME_FOREVER);
...
public int MenuHandler_MusicVolumeMenu(Menu menu, MenuAction action, int param1, int param2)
{
	switch(action)
	{
		case MenuAction_End:
		...
		case MenuAction_Select:
		{
			...
			g_iClientAmbientMusicVolumeIndex[param1] = StringToInt(szInfo);
...
{
	#define PrintMethod PrintToConsole
	
	CPrintToChat(client, "Informtation about Nightcrawler MOD is copied to the console. Press '\x04 ~ \x01' \x01to open up the console!");
...
{
	SetHudTextParams(-1.0, 0.72, HINTMSG_UPDATE_TIME + 0.15, 255, 255, 255, 130);
...
void PrecacheFiles()
{
	...
	for (int i; i < sizeof g_szNightcrawlerKnifeHitSound; i++)
	{
		PrecacheSoundAny(g_szNightcrawlerKnifeHitSound[i]);
		FormatEx(szFile, sizeof szFile, "sound/%s", g_szNightcrawlerKnifeHitSound[i]);
		AddFileToDownloadsTable(szFile);
	}
}
...
bool TeleportClient(int client)
{
	...
	EmitSoundToAllAny(g_szTeleportSound, client, SNDCHAN_TELEPORT);
...
void LoadKeyValues(KeyValues hKv, bool bInsertIntoHandle = false)
{
	enum
	{
		...
		Key_RoundWinSoundsVolume,
		Key_RoundWinSounds_NC,
		Key_RoundWinSounds_Survivor,
		
		Key_AmbientRoundSounds,
	...
	char Keys[Key_Total][] = {
		...
		"RoundWinSounds_Volume",
		"RoundWinSounds_NightcrawlerWin",
		"RoundWinSounds_SurvivorLose",
	...
	if(bInsertIntoHandle)
	{
		...
		KvSetFloat(hKv, Keys[Key_RoundWinSoundsVolume], g_flDefault_RoundWinSoundsVolume);
		
		KvJumpToKey(hKv, Keys[Key_RoundWinSounds_NC], true);
		hKv.GotoFirstSubKey(false);
		KvSetString(hKv, "1", "nightcrawler/feshmeat.mp3");
		hKv.Rewind();
		
		KvJumpToKey(hKv, Keys[Key_RoundWinSounds_Survivor], true);
		hKv.GotoFirstSubKey(false);
		KvSetString(hKv, "1", "nightcrawler/humans_win3.mp3");
		KvSetString(hKv, "2", "nightcrawler/humans_win4.mp3");
		hKv.Rewind();
		
		KvJumpToKey(hKv, Keys[Key_AmbientRoundSounds], true);
		hKv.GotoFirstSubKey(false);
		
		KvSetString(hKv, "1", "nightcrawler/derka.mp3");
		KvSetString(hKv, "2", "nightcrawler/derkf.mp3");
		KvSetString(hKv, "3", "nightcrawler/derki.mp3");
		KvSetString(hKv, "4", "nightcrawler/derkn.mp3");
		KvSetString(hKv, "5", "nightcrawler/derko.mp3");
		KvSetString(hKv, "6", "nightcrawler/derkp.mp3");
		KvSetString(hKv, "7", "nightcrawler/derku.mp3");
	...
	g_flRoundWinSoundsVolume = KvGetFloat(hKv, Keys[Key_RoundWinSoundsVolume], g_flDefault_RoundWinSoundsVolume);
	
	char szDownloadPath[PLATFORM_MAX_PATH];
	if (KvJumpToKey(hKv, Keys[Key_RoundWinSounds_NC], false))
	{
		if(hKv.GotoFirstSubKey(false))
		{
			do
			{
				hKv.GetString(NULL_STRING, szMdl, sizeof szMdl, "");
				TrimString(szMdl);
				FormatEx(szDownloadPath, sizeof szDownloadPath, "sound/%s", szMdl);
				
				if(FileExists(szDownloadPath))
				{
					g_Array_RoundWinSounds_NC.PushString(szMdl);
					g_iRoundWinSoundsCount_NC++;
					
					PrecacheSoundAny(szMdl);
	...
	if (KvJumpToKey(hKv, Keys[Key_RoundWinSounds_Survivor], false))
	{
		if(hKv.GotoFirstSubKey(false))
		{
			do
			{
				...
				if(FileExists(szDownloadPath))
				{
					g_Array_RoundWinSounds_Survivor.PushString(szMdl);
					g_iRoundWinSoundsCount_Survivor++;
	...
	if (KvJumpToKey(hKv, Keys[Key_AmbientRoundSounds], false))
	{
		if(hKv.GotoFirstSubKey(false))
		{
			do
			{
				...
				if(FileExists(szDownloadPath))
				{
					g_Array_AmbientRoundSounds.PushString(szMdl);
					g_iAmbientRoundSoundsCount++;
...
void LoadDefaultValues()
{
	...
	g_flRoundWinSoundsVolume = g_flDefault_RoundWinSoundsVolume;
}
...
void ResetDataSettingsArrays()
{
	if (g_bFirstRun)
	{
		...
		g_Array_RoundWinSounds_NC = new ArrayList(PLATFORM_MAX_PATH);
		g_Array_RoundWinSounds_Survivor = new ArrayList(PLATFORM_MAX_PATH);
		
		g_Array_AmbientRoundSounds = new ArrayList(PLATFORM_MAX_PATH);
	...
	else
	{
		...
		ClearArray(g_Array_RoundWinSounds_NC); g_iRoundWinSoundsCount_NC = 0;
		ClearArray(g_Array_RoundWinSounds_Survivor); g_iRoundWinSoundsCount_Survivor = 0;
		
		ClearArray(g_Array_AmbientRoundSounds); g_iAmbientRoundSoundsCount = 0;
