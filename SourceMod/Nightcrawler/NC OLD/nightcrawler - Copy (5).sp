...
float g_flDefault_FrostGrenadeRadius = 250.0;
...
void ReadPrecacheFile()
{
	...
	if (!FileExists(szFile))
	{
		...
		WriteFileLine(f, "models/weapons/eminem/icecube.dx90.vtx");
		WriteFileLine(f, "models/weapons/eminem/icecube.mdl");
		WriteFileLine(f, "models/weapons/eminem/icecube.phy");
		WriteFileLine(f, "models/weapons/eminem/icecube.vvd");
