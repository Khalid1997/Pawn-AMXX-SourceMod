...
{
	VIPSys_Menu_AddItem("viptag", "Change (Scoreboard, Chat) Tag", MenuAction_Select, ITEMDRAW_DEFAULT, VIPMenuCallback_ChangeTagName, 17);
	VIPSys_Menu_AddItem("viptag_color", "Change Tag Chat Color", MenuAction_Select, ITEMDRAW_DEFAULT, VIPMenuCallback_ChangeTagColor, 15);
}
