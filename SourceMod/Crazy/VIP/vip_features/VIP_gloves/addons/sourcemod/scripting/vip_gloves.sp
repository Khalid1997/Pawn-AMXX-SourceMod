...
public void OnAllPluginsLoaded()
{
	...
	VIPSys_Menu_AddItem("gloves", "Select Gloves Menu", MenuAction_Select, ITEMDRAW_DEFAULT, VIPMenuHandler_OnGlovesMenu, 4);
}

public void OnPluginEnd()
{
	VIPSys_Menu_RemoveItem("gloves");
}
...
public int VIPMenuHandler_OnGlovesMenu(Menu menu, char[] szInfo, MenuAction action, int param1, int param2)
{
