...
bool g_bIsVIP[MAXPLAYERS] = false;

bool g_bLate;

public APLRes AskPluginLoad2(Handle hPlugin, bool bLate, char[] szError, int iErr)
{
	g_bLate = bLate;
...
public void OnAllPluginsLoaded()
{
	...
	VIPSys_Menu_AddItem("surf_trails", "Surf Trails", MenuAction_Select, ITEMDRAW_DEFAULT, VIPMenuCallback_ItemSelect, 0);
}
...
{
	if(!IsPlayerAlive(client) || gI_SelectedTrail[client] == 0 || gB_StopPlugin[client])
	{
		return;
	}
