...
public void OnPluginStart()
{
	...
	gH_Cvar_Table_Prefix = CreateConVar("sm_ctban_table_prefix", "ctban_", "Adds a prefix to the CT Bans table, leave this blank unless you have a need to add a prefix for multiple servers on one database.", FCVAR_NONE);
	gH_Cvar_Database_Driver = CreateConVar("sm_ctban_database_driver", "ctban", "Specifies the configuration driver to use from SourceMod's database.cfg", FCVAR_NONE);
