...
void CreateTrade(int client, int target, int item, int target_item)
{
	...
	char sQuery[2048];
	Format(sQuery, sizeof(sQuery), sQuery_CreateTrade, STORE_DATABASE_PREFIX, Store_GetClientUserID_Ex(client), Store_GetClientUserID_Ex(target), sItem, sTargetItem);
