...
// Edited By khaled
// Fix warnings and do not require sourcebans
// And fixed warnings in lastrequest.sp for view_as<DataPackPos>
// And shot4shot not working
//#define FindSend#PropOffs FindSendPropInfo
// And also fixed Host Error error by changiing where to precache sounds from OnConfigsExec.. to OnMapStart
//#define SBBanPlayer BanClient
...
#define SBBanPlayer SourceBans_BanPlayer
