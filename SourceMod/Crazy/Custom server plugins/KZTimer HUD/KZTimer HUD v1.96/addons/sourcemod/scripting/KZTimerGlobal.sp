...
public OnClientPutInServer(client)
{
	...
	if (g_hGlobalBanListArray != INVALID_HANDLE)
	{
		for (new i = 0; i < GetArraySize(g_hGlobalBanListArray); i++)
		{
			...
			{
				KickClient(client, "You are globally banned! For more information visit:\nforum.gokz.org/p/player-rules\nportal.global-api.com/dashboard/bans");
				return;
			}
		}
	}
