...
void ShowClientHelp(int client)
{
	...
	char line[64]
	FormatEx(line, sizeof(line), "%T", "HELP_KICK_BALL", client, "E")
	DrawPanelText(panel, line)
	FormatEx(line, sizeof(line), "%T", "HELP_UPGRADE_MENU", client, "R")
	DrawPanelText(panel, line);
	FormatEx(line, sizeof(line), "%T", "HELP_TURBO", client, "G")
	DrawPanelText(panel, line)
	FormatEx(line, sizeof(line), "%T", "HELP_CURVE_LEFT", client, "Shift+A")
	DrawPanelText(panel, line);
	FormatEx(line, sizeof(line), "%T", "HELP_CURVE_RIGHT", client, "Shift+D")
	DrawPanelText(panel, line)
	FormatEx(line, sizeof(line), "%T", "HELP_HELP", client, "help")
	DrawPanelText(panel, line)
