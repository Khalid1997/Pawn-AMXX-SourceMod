...
public MultiMod_VotingStarted(MultiModVote:iVote, bool:bInstanChange, iNextModId)
{
	g_bVoteStarted = true;
}
/*
...
AttemptRTV(client)
{
	...
	{
		MM_PrintToChat(0, "Enough players have Rocked The Vote! Starting vote in \x05%d \x01seconds.", RoundFloat(g_Cvar_ChangeTime.FloatValue));
		StartRTV();
	}	
}
...
{
	g_bVoteStarted = MultiMod_StartVote();
	return Plugin_Stop;
}
