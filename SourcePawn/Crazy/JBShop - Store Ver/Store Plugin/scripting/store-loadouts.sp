...
public APLRes AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	...
	ChangedForward = CreateGlobalForward("Store_OnClientLoadoutChanged", ET_Event, Param_Cell);
...
public void OnMapStart()
{
	...
	{
		Store_GetLoadouts(INVALID_HANDLE, Custom_LoadOutReadyCallback, false);
	}
}
...
public void Custom_LoadOutReadyCallback(int[] loadouts, int count, any data)
{
	g_bLoadoutsReady = true;
}
...
public void Event_PlayerSpawn(Handle event, const char[] name, bool dontBroadcast)
{
	...
	//PrintToServer("** clinet loadout %d", g_clientLoadout[client]);
		...
		case MenuAction_Select:
			{
				...
				Call_StartForward(ChangedForward);
