...
int ConfigProcessingFunc:processingFunctions[MAX_CONFIGS]
...
void CreateConfig(const char[] fileName, const char[] rootSectionName, ConfigProcessingFunc processingFunc)
{
