...
public plugin_init()
{
	...
	register_concmd("amx_kick", "cmdKick", ADMIN_BAN|ADMIN_LEVEL_H|ADMIN_LEVEL_G, "<name or #userid> [reason]")
	register_concmd("amx_ban", "cmdBan", ADMIN_BAN|ADMIN_LEVEL_H, "<name or #userid> <minutes> [reason]")
	...
	register_concmd("amx_slay", "cmdSlay", ADMIN_BAN|ADMIN_LEVEL_H|ADMIN_LEVEL_G, "<name or #userid>")
	register_concmd("amx_slap", "cmdSlap", ADMIN_BAN|ADMIN_LEVEL_H|ADMIN_LEVEL_G, "<name or #userid> [power]")
	register_concmd("amx_leave", "cmdLeave", ADMIN_BAN|ADMIN_LEVEL_H|ADMIN_LEVEL_G, "<tag> [tag] [tag] [tag]")
	...
	register_concmd("amx_map", "cmdMap", ADMIN_BAN|ADMIN_LEVEL_G, "<mapname>")
	register_concmd("amx_cfg", "cmdCfg", ADMIN_CFG, "<filename>")
	register_concmd("amx_nick", "cmdNick", ADMIN_BAN|ADMIN_LEVEL_H, "<name or #userid> <new nick>")
	register_concmd("amx_last", "cmdLast", ADMIN_BAN|ADMIN_LEVEL_H|ADMIN_LEVEL_G, "- list the last few disconnected clients info");
...
{
	if( !cmd_access(id, ADMIN_BAN|ADMIN_LEVEL_G|ADMIN_LEVEL_H, cid, 1) )
	...
	{
		client_print(0, print_chat, "Golden Player %s: has kicked %s.", name, name2)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: has kicked %s.", name, name2)
	}
...
public cmdUnban(id, level, cid)
{
	...
	{
		client_print(0, print_chat, "Golden Player %s: unban %s", name, arg)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: unban %s", name, arg)
	}
...
{
	if( !cmd_access(id, ADMIN_BAN|ADMIN_LEVEL_G|ADMIN_LEVEL_H, cid, 1) ) // check for ADMIN_BAN access
	{
	...
	{
		client_print(0, print_chat, "Golden Player %s: ban %s", name, arg)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: ban %s", name, arg)
	}
...
{
	if( !cmd_access(id, ADMIN_BAN|ADMIN_LEVEL_H, cid, 1) )
		return PLUGIN_HANDLED
...
public cmdSlay(id, level, cid)
{
	...
	{
		client_print(0, print_chat, "Golden Player %s: slay %s", name, name2)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: slay %s", name, name2)
	}
...
public cmdSlap(id, level, cid)
{
	...
	{
		client_print(0, print_chat, "Golden Player %s: slap %s with %d damage", name, name2, damage)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: slap %s with %d damage", name, name2, damage)
	}
...
public cmdMap(id, level, cid)
{
	...
	{
		client_print(0, print_chat, "Golden Player %s: changelevel %s", name, arg)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: changelevel %s", name, arg)
	}
...
public cmdNick(id, level, cid)
{
	...
	{
		client_print(0, print_chat, "Golden Player %s: change nick of %s to %s", name, name2, arg2)
	}
	else if(get_user_flags(id) & ADMIN_LEVEL_G)
	{
		client_print(0, print_chat, "Silver Player %s: change nick of %s to %s", name, name2, arg2)
	}
