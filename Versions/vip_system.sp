...
#define MAX_FEATURES_ALIASES 32
...
bool g_bDebug;
int g_iClientFeatures[MAXPLAYERS][MAX_FEATURES];

char g_szFeatureAliasName[MAX_FEATURES_ALIASES][MAX_FEATURE_ALIAS_NAME];
bool g_szFeatureAlias[MAX_FEATURES_ALIASES][MAX_FEATURES];

char g_szFeatureName[MAX_FEATURES][MAX_FEATURE_NAME];
FeatureStatus g_iFeatureStatus[MAX_FEATURES];

/* ---- FileKeys ----- */
// --
char SECTION_SETTINGS[] = "Settings";
char KEY_DEBUG[] = "Debug";

// -
char SUBSECTION_HAPPYHOUR = "happyhour";
char KEY_FREEHOUR_ENABLED = "enabled";
char KEY_FREEHOUR_GROUP = "group";
char KEY_FREEHOUR_DAYS = "days";
char KEY_FREEHOUR_START = "start";
char KEY_FREEHOUR_END = "end";
// -
// --

// --
char SECTION_ALIASES[] = "FeatureAliases";
// --

// --
char SECTION_GROUPS[] = "Groups";
char KEY_FLAGS[] = "flags";
char KEY_FEATURES[] = "features";
//--
